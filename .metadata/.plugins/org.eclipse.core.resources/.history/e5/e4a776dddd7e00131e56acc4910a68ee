...
src/%.o: ../src/%.cpp
	...
	g++ -O2 -g -Wall -c -fmessage-length=0 -lcrafter -lboost_thread -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
...
src/Emulation\ Project.o: ../src/Emulation\ Project.cpp
	@echo 'Building file: $<'
	@echo 'Invoking: GCC C++ Compiler'
	g++ -O2 -g -Wall -c -fmessage-length=0 -lcrafter -lboost_thread -MMD -MP -MF"src/Emulation Project.d" -MT"src/Emulation\ Project.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
